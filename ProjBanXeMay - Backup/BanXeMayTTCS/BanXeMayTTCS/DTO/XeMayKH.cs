    ...
    namespace BanXeMayTTCS.DTO
    {
        public class XeMayKH
        {
            ...
            public XeMayKH(string maXeMay, string tenXeMay, decimal gia, string moTa, string trangThai, string hinhAnh, string loai, string hang)
            {
            ...
            public XeMayKH(string maXeMay, string tenXeMay, decimal gia, int soLuongTon, string moTa, string trangThai, string hinhAnh, string loai, string hang, string nhaCungCap)
            {
                this.maXeMay = maXeMay;
                this.tenXeMay = tenXeMay;
                this.gia = gia;
